                                              ...
                                              <div class="modal-dialog" role="document">
                                                   <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                        	<form id="loginForm"  method="post" action="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/verifyLogin" >
                                                        		<div class="row">
                                                         			<div class="col-sm-12">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/getIndex">Home</a></li>
