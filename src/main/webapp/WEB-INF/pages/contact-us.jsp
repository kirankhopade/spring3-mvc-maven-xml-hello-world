                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/getProgressReport">Progress Report</a></li>
                         ...
                         <c:if test="${not empty facultysignin}">
                            ...
                            <li><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/instituteservices/getInstitutewiseReportPage">School Reports</a></li>
                         </c:if>
                        ...
                        <li class="active"><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/getContactUs">Contact Us</a></li>                     
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
    ...
    <section id="contact-info">
        <div class="center">        
            ...
            <div class="row contact-wrap"> 
                ...
                <form  method="post" action="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/sendmail">
