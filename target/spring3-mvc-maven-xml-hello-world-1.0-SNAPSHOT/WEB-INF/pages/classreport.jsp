      ...
      function drawChartForAllExam(jsonData) {
       ...
       //   alert(obtainedtotal);
        ...
        function madeAjaxCallForGeaphData(reporttype,schoolid,classname,division,examname){
            $.ajax({
                    type: "get",
                    url: "http://localhost:8080/spring3-mvc-maven-xml-hello-world/instituteservices/getExamwiseReport",
                    cache: false,               
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/getStudentProfile">Class Reports</a></li>
                        <li   class="active"><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/getProgressReport">School Reports</a></li>
                        <li><a href="http://localhost:8080/spring3-mvc-maven-xml-hello-world/studentservices/getAttendenceReport">Attendence Reports</a></li>
